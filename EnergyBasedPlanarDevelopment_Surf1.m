...
addpath(genpath('C:/Users/eyavuz/Documents/MATLAB/Doktora/gptoolbox/'))
...
%%
niter=25;
permissible_El=0.405;
permissible_EA=0.1550;
permissible_E=0.05;
permissible_N=82;
...
if (h==1 | h==5 | h==10 | h==20 | h==30| h==35| h==60| h==70| h==80| h==90| h==100) 
    figure;
...
Const_timestep1=0.0005+0.005*exp(-(0.4202-El)/0.002);
Const_timestep2=0.0005+0.005*exp(-(0.2038-EA)/0.002);
